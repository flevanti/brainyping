...
//run in background and is relatively faster that php.exe
$cmd_param["cron"] = 0; //CRON: means that the WD process has been scheduled so we do not need to tell him to wait.
