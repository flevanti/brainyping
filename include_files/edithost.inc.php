...
<form class="text_left" style="margin-left: auto; margin-right: auto; width: 450px;" role="form" method="POST" action=""
      id="formedithost">
    <div class="form-group">
        <label for="title">Monitor friendly name</label>
        <input type="text" class="form-control" id="title" name="title" placeholder="Monitor friendly name"
               value="<?php echo t2f($host_manager->editedHostGetInfo("title")); ?>">
    </div>
    ...
    <div style="float:left; width:80%;">
        <div class="form-group">
            ...
            <select id="check_type" name="check_type"
                    class="form-control"  <?php echo($id_host != "new" ? "disabled=\"disabled\"" : ""); ?> >
                <?php
            ...
            <input type="hidden" name="check_type_old" id="check_type_old"
                   value="<?php echo t2f($host_manager->editedHostGetInfo("checktype")); ?>">
    ...
    <div style="float:left; width:20%; padding-left: 15px;">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="interval" id="interval" placeholder="Minutes"
                   value="<?php echo t2v($host_manager->editedHostGetInfo("interval")); ?>">
            <input type="hidden" name="interval_old" id="interval_old"
                   value="<?php echo t2v($host_manager->editedHostGetInfo("interval")); ?>">
        </div>
    </div>
    ...
    <div id="host_port_section" class="checktype_section">
        ...
        <div style="float:left; width:80%;">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="host_address" name="host_address"
                       placeholder="Host domain or IP"
                       value="<?php echo t2v($host_manager->editedHostGetInfo("host")); ?>">
            </div>
        </div>
        ...
        <div style="float:left; width:20%; padding-left: 15px;">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="host_port" id="host_port" placeholder="Port"
                       value="<?php echo t2v($host_manager->editedHostGetInfo("port")); ?>">
            </div>
        </div>
        <!-- END HOST AND PORT-->
    </div>
    ...
    <div id="url_only_section" class="checktype_section">
        ...
        <p class="micro_text WEBKEYWORD">This monitor verifies if a word is present (or not using # as first char) in a
            webpage</p>

        <div class="form-group">
            <label for="host_url">URL to check (Please specify HTTP:// or HTTPS://)</label>
            <input type="text" class="form-control" id="host_url" name="host_url" placeholder="URL"
                   value="<?php echo t2v($host_manager->editedHostGetInfo("host")); ?>">
        </div>
        ...
        <div class="form-group checktype_additional_fields WEBKEYWORD">
            ...
            <input type="text" class="form-control" id="host_url_keyword" name="host_url_keyword" placeholder="Keyword"
                   value="<?php echo t2v($host_manager->editedHostGetInfo("keyword")); ?>">
        </div>
    ...
    <div class="form-group">
        ...
        <div
            style="width:100%;border:1px solid lightgray; background-color: #ffffff; max-height: 100px; overflow-y: auto; border-radius: 5px; padding-left:5px;">
    ...
    <input type="hidden" name="public_token"
           value="<?php echo($id_host == "new" ? "new" : $host_manager->editedHostGetInfo("public_token")); ?>">
</form>
