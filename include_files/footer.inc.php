...
echo "&nbsp;&nbsp;&nbsp;";
echo "<a href=\"https://github.com/flevanti/brainyping\" target='_blank' title=\"Brainyping on GitHub\" alt=\"Brainyping on GitHub\"><img style=\"vertical-align: baseline;\" src=\"imgs/github12x12.png\"></a>";
echo "<br>";
echo "DB CONNECTIONS: ";
if (isset($mydbh)) {
    echo "[engine] ";
