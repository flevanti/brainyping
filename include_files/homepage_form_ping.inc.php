...
<div class="" id="form_ping_request_hp">
    <form class="form-inline" id="form_web_check">
        <input type="text" class="input_host_ping_hp input-lg form-control  " value=""
            ...
            >
        <button id="submit_web_check" class="btn btn-warning btn-lg ">FIND MONITOR</button>
        <br>
        <span class="micro_text" id="">&nbsp;
            <span id="alert_hp_monitor_not_found">Monitor not found! <a href="/signup/">Why don't you register and add
                    your own monitors?</a></span>
